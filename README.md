![System: Debian 8+](https://img.shields.io/badge/System-Debian%208+-brightgreen.svg) ![TeamSpeak-Version: 3.12.0](https://img.shields.io/badge/Teamspeakversion-3.12.0-brightgreen.svg)
...
Update to 3.12.0
===
To update to 3.12.0, just copy the following line and paste it into your terminal.

<code>bash <(wget -O- --no-check-certificate 'https://raw.githubusercontent.com/niclasreich/teamspeak-installer/master/update-3.12.0')</code>
